      ...
      <div className="p-8">
        ...
        <div className="flex flex-wrap gap-2 mt-6">
          {technologies.map((tech) => (
            <span
              key={tech}
              className="px-4 py-2 rounded-full bg-violet-600/20 text-violet-300 text-sm"
            >
              {tech}
            </span>
          ))}
        ...
        <div className="flex gap-4 mt-8">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex-1 text-center py-3 rounded-xl bg-violet-600 hover:bg-violet-700 transition"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex-1 text-center py-3 rounded-xl border border-white/10 hover:border-violet-500 transition"
          >
